    ...
    <section class="h-screen">
      <div class="container font-bold text-center bg-pattern flex h-screen">
        <div class="px-10 pt-30 m-auto">
          ...
          <button class="bg-white hover:bg-orange-400 text-blue-400 font-semibold hover:text-white py-2 px-4 border border-blue-300 hover:border-transparent rounded m-5">
            Work with me
          </button>
        </div>
      </div>
